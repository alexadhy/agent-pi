...
<style>
  ...
  body.theme-dark {
    ...
    --error: #f38ba8;
    --purple: #cba6f7;
    --purple-bg: rgba(203, 166, 247, 0.08);
  }
  ...
  body.theme-light {
    ...
    --error: #d20f39;
    --purple: #8839ef;
    --purple-bg: rgba(136, 57, 239, 0.08);
  }
...
function getStoredTheme() {
  try { return localStorage.getItem('research-viewer-theme'); } catch { return null; }
}

function applyTheme(theme) {
  document.body.className = theme;
  try { localStorage.setItem('research-viewer-theme', theme); } catch {}
}
