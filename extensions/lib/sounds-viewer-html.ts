...
<style>
  ...
  body.theme-dark {
    ...
    --success-dim: rgba(166, 227, 161, 0.15);
    --warning: #fab387;
  ...
  body.theme-light {
    ...
    --accent-glow: rgba(30, 102, 245, 0.25);
    --success: #40a02b;
    --success-bg: rgba(64, 160, 43, 0.08);
    --success-dim: rgba(64, 160, 43, 0.15);
    --warning: #fe640b;
    --warning-bg: rgba(254, 100, 11, 0.08);
    --error: #d20f39;
    --error-bg: rgba(210, 15, 57, 0.08);
    --purple: #8839ef;
    --purple-dim: rgba(136, 57, 239, 0.12);
...
(function() {
  ...
  function getStoredTheme() {
    try { return localStorage.getItem('sounds-viewer-theme'); } catch { return null; }
  }

  function applyTheme(theme) {
    document.body.className = theme;
    try { localStorage.setItem('sounds-viewer-theme', theme); } catch {}
  }
