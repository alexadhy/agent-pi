...
export default function (pi: ExtensionAPI) {
  ...
  function hasRunningOperations(): boolean {
    ...
    // Check subagents
    if (
      typeof g.__piHasRunningSubagents === "function" &&
      g.__piHasRunningSubagents()
    ) {
      return true;
    }
    ...
    if (
      g.__piActiveChain &&
      typeof g.__piHasRunningChain === "function" &&
      g.__piHasRunningChain()
    ) {
      return true;
    }
    ...
    // Check pipeline
    if (
      g.__piActivePipeline &&
      typeof g.__piHasRunningPipeline === "function" &&
      g.__piHasRunningPipeline()
    ) {
      return true;
    }
